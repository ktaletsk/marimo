...
export function createErrorToastingRequests(
  ...
  const MESSAGES: Record<RequestKey, string> = {
    ...
    listCondaEnvironments: "Failed to list conda environments",
    getNotebookCondaEnvironment: "Failed to read conda env binding",
    setNotebookCondaEnvironment: "Failed to update conda env binding",
