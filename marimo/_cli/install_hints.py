...
_INSTALL_COMMAND_RULES: Final[tuple[CommandRule, ...]] = (
    ...
    CommandRule("mamba", "any", "mamba install -y {packages}"),
    CommandRule("micromamba", "any", "micromamba install -y {packages}"),
...
_POST_INSTALL_COMMAND_RULES: Final[tuple[CommandRule, ...]] = (
    ...
    CommandRule("mamba", "any", "mamba run {command}"),
    CommandRule("micromamba", "any", "micromamba run {command}"),
...
_UPGRADE_COMMAND_RULES: Final[tuple[CommandRule, ...]] = (
    ...
    CommandRule("mamba", "any", "mamba update -y {packages}"),
    CommandRule("micromamba", "any", "micromamba update -y {packages}"),
