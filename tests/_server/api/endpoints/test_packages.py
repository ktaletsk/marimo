...
# The POST /api/packages/conda_environment endpoint was removed in the
# option-B refactor: conda env selection lives in the notebook's
# [tool.marimo] block and is read (not mutated) by marimo. Programmatic
# updates use update_marimo_tool_in_script directly.
